...
---
## Summary
- 18+ years professional experience with web, mobile apps, and military software
- 6+ years experience leading software teams (4–6 direct reports), building new product lines
- Multiple open-source projects (compilers, image processing, web-scrapers, automation, analytics)
- Integration of AI tooling to speed up delivery (Cursor, Aider, Copilot/Codex, Gemini)

---
## Technical Skills
- **Languages:** JavaScript/TypeScript, Python, Perl, Swift, Ruby, C/C++, Java
- **Front-end:** React, Svelte, D3, Angular, Webpack
- **Back-end:** Node.js, Express, Docker/Kubernetes, AWS, Azure
- **Databases:** PL/SQL (Oracle/Postgres), Mongo, Snowflake, Cassandra, Redis, Kafka, CouchDB
...
**Mar 2024 – Present**
Leading Pricing Engine team (6 developers), maintaining several pieces of core infrastructure (cost-estimate logic, pricing logic, 3rd party plugins) and rebuilding the entirety of the pricing engine:

- Refactored legacy Pricing codebase to make feature additions and troubleshooting simpler
- Unified margin adjustment logic flow for 17 processes, implemented 3 new processes (tube cutting/bending, injection molding), and integrated several new suppliers into the ecosystem
- Improved cost-prediction accuracy by rewriting a portion of costing logic
...
- Launched 3 new plastic/composite materials and 1 new metal material
- Addressed multiple long-standing bugs and improved user experience
...
- Performed DevOps and AWS troubleshooting

---
### Zaius — Principal Developer (Web)

**Aug 2019 – Feb 2020**
Development of a web-based CRM platform (TypeScript, React, D3):

- Built out the analytics portion of the Zaius frontend
- Improved product architecture and best practices in testing and deployment
...
- Developed internal analytics/logging platform scaling to millions of entries per day using Kafka, Cassandra, React frontend, and Java backend
...
- Built public APIs with rate limiting & OAuth; implemented Jenkins-driven regression tests
...
### Drone
Puppeteer-based web-scraping/testing framework that builds a graph representation of websites and automates navigation, UX testing, and fault recovery using a declarative approach. Functions like GPS for the web.  
